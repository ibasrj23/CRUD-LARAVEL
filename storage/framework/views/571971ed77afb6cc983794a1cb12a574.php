<?php $__env->startSection('title', 'Baca: ' . ($post->title ?? 'Post Tidak Ditemukan')); ?>
...
<div class="card shadow-lg border-0 mx-auto stylish-card">
        ...
        <div class="row mb-5 text-muted small meta-section">
            <div class="col-md-6">
                <p class="mb-1">
                    ...
                    <strong>Penulis:</strong> <?php echo e($post->user?->name ?? 'Tim Redaksi'); ?>
            ...
            <div class="col-md-6 text-md-end">
                <p class="mb-0">
                    ...
                    <strong>Dipublikasi:</strong> <?php echo e(\Carbon\Carbon::parse($post->published_at)->translatedFormat('d F Y')); ?>
        ...
        <?php if($post->image): ?>
            <div class="mb-5 d-flex justify-content-center">
                <div class="image-frame">
                    <img src="<?php echo e(asset('image/' . $post->image)); ?>" alt="<?php echo e($post->title); ?>" class="img-fluid rounded-4 main-image">
                </div>
            </div>
        <?php else: ?>
    ...
    <div class="card-footer bg-light border-top text-end">
        <a href="<?php echo e(route('posts.public.index')); ?>" class="btn btn-secondary shadow-sm rounded-pill px-4 py-2 hover-lift">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASUSTeK\latihan-laravel\resources\views/posts/public_show.blade.php ENDPATH**/ ?>